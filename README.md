...
This Laravel Permission UI package has been forked from the [original](https://github.com/LaravelDaily/laravel-permission-ui) and has been ported to Tailwind CSS 4.
...
The visual design is based on simple Tailwind CSS 4 classes.
